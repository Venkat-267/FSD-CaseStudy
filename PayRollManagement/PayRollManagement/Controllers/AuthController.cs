...
namespace PayRollManagement.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IConfiguration configuration, TokenService tokenService, IUserRepository userRepo, IAdminRepository adminRepo, PayMasterDbContext context)
        {
        ...
        public async Task<IActionResult> Login(LoginDto dto)
        {
            try
            {
                var user = await _context.Users
                    .Include(u => u.Role)
                    .FirstOrDefaultAsync(u => u.UserName == dto.Username && u.Password == ComputeHash(dto.Password));
